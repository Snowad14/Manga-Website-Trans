...
class CommonOCR(InfererModule):
    ...
    def recognize(self, image: np.ndarray, regions: List[TextBlock], verbose: bool = False) -> List[TextBlock]:
        '''
        ...
        '''
        return self._recognize(image, regions, verbose)

    @abstractmethod
    def _recognize(self, image: np.ndarray, regions: List[TextBlock], verbose: bool = False) -> List[TextBlock]:
        pass

class OfflineOCR(CommonOCR, ModelWrapper):
    _MODEL_SUB_DIR = 'ocr'

    def _recognize(self, *args, **kwargs):
        return self.infer(*args, **kwargs)

    @abstractmethod
    def _infer(self, image: np.ndarray, regions: List[TextBlock], verbose: bool = False) -> List[TextBlock]:
        pass
